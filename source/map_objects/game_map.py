...
class GameMap:
   ...
   def make_map(self):
        ...
        self.create_h_tunnel(30, 35, 22)
        self.create_h_tunnel(30, 35, 23)
    '''
    ...
    def create_room(self, room):
        # go through tiles in specified rect and make passable
    ...
    def place_entities(self, room, entities, max_monsters_per_room):
        # Get rand # of monsters
        number_of_monsters = randint(0, max_monsters_per_room)

        for i in range (number_of_monsters):
            # Choose a rand location in room
